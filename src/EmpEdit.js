...
const EmpEdit = () => {
    ...
    const handlesubmit=(e)=>{
      e.preventDefault();
      const empdata={id,firstname,lastname,email,phone,active};
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-12">
                                    <div className="form-group">
                                        ...
                                        <input required value={lastname} onMouseDown={e=>valchange(true)} onChange={e=>lnamechange(e.target.value)} className="form-control"></input>
                                    {lastname.length==0 && validation && <span className="text-danger">Enter the First name</span>}
                                    </div>
                                </div>
